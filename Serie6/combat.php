...
echo 'Le personnage 1 gagne ', $perso1->experience(), ' d\'expérience, contrairement au personnage 2 qui gagne ', $perso2->experience(), ' d\'expérience.<br />';
echo 'Le personnage 1 prend ', $perso1->degats(), ' de dégâts, contrairement au personnage 2 qui prend ', $perso2->degats(), ' de dégâts.<br />';